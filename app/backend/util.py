...
def create_corpus_names():
    ...
    for category_path in corpus_category_paths:
        ...
        for  topic_path in  corpus_topic_paths:
            ...
            # category_names['pubmed']: [pubmed/gene, pubmed/mutation]

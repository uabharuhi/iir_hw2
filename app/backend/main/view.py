...
@App.route('/tfidf_main/<article_title>')
def tfidf_main(article_title):
    print('12345678')
    normal_tfidf = ir_sys.get_tfidf_of_article_all_corpus(article_title)
    porter_tfidf = ir_sys_porter.get_tfidf_of_article_all_corpus(article_title)
...
def detail_match(article_title,token_string,token_algorithm):
    ...
    article = ir_sys_for_query.findArticleByTitle(article_title)
